...
const state = (() => { // IIFE = Immediatly Invoked Function Expression
    let exchangeRate = {}
...
const APIKey = '20c06fa21fda3b81780bd0ab'
const getUrl = currency =>
    `https://v6.exchangerate-api.com/v6/${APIKey}/latest/${currency}`

const getErrorMessage = errorType => ({
    'unsupported-code': 'A moeda não existe em nosso banco de dados.',
    'base-code-only-on-pro': 'Informações de moedas que não sejam USD ou EUR só podem ser acessadas a partir do plano premium.',
    'malformed-request': 'O endpoint do seu request precisa seguir a estrutura à seguir: https://v6.exchangerate-api.com/v6/{key}}/latest/USD',
...
const showInitialInfo = ({ conversion_rates }) => {
    ...
    showUpdatedRates({ conversion_rates }) // conversion_rates: conversion_rates
}
